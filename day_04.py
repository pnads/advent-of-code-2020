...
with open('input_files/input_day_04.txt', 'r') as f:
    batch_file = f.read()
...
# break up passports into separate lines of a list
batch_file = batch_file.rstrip("\n")
passports_pre = batch_file.split("\n\n")

# Reformat passports into a list of dicts
valid_passports = []
for passport in passports_pre:
    passport = passport.replace('\n', ' ')
    passport = passport.split(' ')
    passport = [piece.split(':') for piece in passport]
    passport = {key: value for key, value in passport}
...
print(f'Number of Truly Valid Passports: {len(truly_valid_passports)}')

# Number of valid passports: 247
# Number of Truly Valid Passports: 145
